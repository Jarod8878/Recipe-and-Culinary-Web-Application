...
<body>
    ...
    <div class="container container-content">
        ...
        <div class="card mb-3">
            ...
            <?php if (!empty($recipe['recipe_id']) && isset($_SESSION['user_id'])): ?>
                <div class="p-3 border-top">
                    <form action="../CommunityEngagementModule/rating.php" method="POST" class="d-flex align-items-center flex-wrap gap-2">
                        <input type="hidden" name="recipe_id" value="<?= $recipe['recipe_id'] ?>">
                        <label for="rating" class="form-label mb-0 me-2"><strong>Rate this recipe:</strong></label>
            ...
            <div class="card-footer">
                <div class="d-grid gap-2">
                    <a href="../CommunityEngagementModule/post_discussion.php?recipe_id=<?= $recipe['recipe_id'] ?>" class="btn btn-primary">
                        <i class="bi bi-chat-dots-fill me-1"></i> Post Discussion
                    </a>
                    <a href="recipe_index.php" class="btn btn-secondary">
